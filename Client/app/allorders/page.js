...
const AdminOrders = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        const res = await fetch(`https://https://unlimiteddatagh.onrender.com/api/orders?${params.toString()}`, {
          headers: {
  ...
  const updateOrderStatus = async (orderId, newStatus) => {
    ...
    try {
      const res = await fetch(`https://https://unlimiteddatagh.onrender.com/api/orders/${orderId}/status`, {
        method: "PUT",
        headers: {
