...
{`{
  ...
  "expiresIn": 365  // Optional: Days until expiry
          ...
          <div className="mb-8" id="purchase-endpoint">
            ...
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <p className="font-medium text-gray-800">POST  https://unlimiteddatagh.onrender.com/api/developer/purchase</p>
...
export default async function handler(req, res) {
  ...
  try {
    const response = await axios.post(
      'https://unlimiteddatagh.onrender.com/api/developer/purchase',
      {
        phoneNumber,
        network,
        capacity,
...
class DataMartService {
  constructor(apiKey) {
    this.apiKey = apiKey;
    this.baseUrl = 'https://unlimiteddatagh.onrender.com/api/developer';
...
class DataMartClient:
    def __init__(self, api_key):
        ...
        self.base_url = 'https://unlimiteddatagh.onrender.com/api/developer'
        self.headers = {
            'Content-Type': 'application/json',
            'X-API-Key': api_key
        }
